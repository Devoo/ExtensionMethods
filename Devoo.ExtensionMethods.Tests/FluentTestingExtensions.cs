...
namespace System
{
    public static class FluentTestingExtensions
    {
        ...
        {
            Assert.IsTrue(actual.ContainsIgnoreCase(containedString));
        ...
        [DebuggerStepThrough]
        [DebuggerHidden]
        public static FluentAnd<string> AssertEqualIgnoringCaseTo(this string actual, string comparisonObject)
        {
            Assert.IsTrue(comparisonObject.EqualsIgnoreCase(actual), "Strings missmatch: '" + actual + "' and '" +comparisonObject+ "'");
            return new FluentAnd<string>(actual);
        }
