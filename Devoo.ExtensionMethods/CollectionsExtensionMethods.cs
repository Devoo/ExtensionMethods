...
namespace System
{
        ...
        static class DevooCollectionsExtensionMethods
    {
        ...
        /// <summary>
        /// Convierte un HasTable a un Dictionary
        /// </summary>
        ...
        /// <returns>Hastable convertido a diccionario</returns>
        public static Dictionary<TKey, TValue> ToDictionary<TKey, TValue>(this Hashtable hash)
        {
            Dictionary<TKey, TValue> res = new Dictionary<TKey, TValue>(hash.Count);
